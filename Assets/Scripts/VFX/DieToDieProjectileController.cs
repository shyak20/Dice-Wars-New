...
/// Reroll action icons are driven by <see cref="DiceRollOutcomeFlyoutController"/> (not this component).
/// </summary>
/// <remarks>
/// FightScene setup:
/// 1. Create empty GameObject "Die To Die Projectiles" and add this component.
/// 2. On CombatManager, assign this controller, default projectile prefab, and DiceRollOutcomeFlyoutController.
...
/// 4. Optionally assign per-gem prefabs on gem effect rows (RandomBatchRerollOtherDiceNoPower).
/// </remarks>
