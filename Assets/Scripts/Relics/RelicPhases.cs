...
public static class RelicPhases
{
    ...
    public const string QueryPerfectAtMaxPlusOne = "Relic_QueryPerfectAtMaxPlusOne";
    ...
    public const string QueryMaxRollsBonus = "Relic_QueryMaxRollsBonus";
    public const string QueryShopDiscountPercent = "Relic_QueryShopDiscountPercent";
    public const string QueryMapCorruptionDamageReductionPercent = "Relic_QueryMapCorruptionDamageReductionPercent";
