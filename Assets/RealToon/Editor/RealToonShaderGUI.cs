...
static bool enab_vrclvs = false;
static string enab_vrclvs_string = "Enable 'VRC Light Volumes' Support";
        ...
        MaterialProperty _N_F_LLI;
        MaterialProperty _LLI_Min;
        MaterialProperty _LLI_Max;
        ...
        MaterialProperty _PresAdju;
        MaterialProperty _ClipAdju;
        MaterialProperty _PASize;
        MaterialProperty _PASmooTrans;
        MaterialProperty _PADist;
            ...
            if (ShowUI == true)
            {
                ...
                if (shader_name == "default_d" || shader_name == "tessellation_d" || shader_name == "default_ft" || shader_name == "tessellation_ft")
                {
                    if (_N_F_O.floatValue == 1)
                    {
                        ...
                        if (ShowOutline)
                        {
                            ...
                            materialEditor.ShaderProperty(_OutResi, new GUIContent(_OutResi.displayName, TOTIPS[153]));
                ...
                if (_N_F_SL.floatValue == 1)
                {
                    ...
                    if (ShowSelfLit)
                    {
                        ...
                        materialEditor.ShaderProperty(_N_F_SLMM, new GUIContent(_N_F_SLMM.displayName, TOTIPS[151]));

                        GUILayout.Space(1);

                        if (_N_F_SLMM.floatValue == 1)
                        {
                            materialEditor.ShaderProperty(_MaskSelfLit, new GUIContent("Self Lit Map", TOTIPS[152]));
                        }
                        else
                        {
                ...
                if (ShowShadow)
                {
                    ...
                    if (_N_F_ST.floatValue == 1)
                    {
                        ...
                        if (_N_F_ST.floatValue == 1)
                        {
                            ...
                            EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
                            materialEditor.ShaderProperty(_N_F_STSDFM, new GUIContent(_N_F_STSDFM.displayName, TOTIPS[141]));
                ...
                if (ShowLighting)
                {
                    ...
                    GUILayout.Space(10);
                    materialEditor.ShaderProperty(_N_F_LLI, new GUIContent(_N_F_LLI.displayName, TOTIPS[148]));
                    EditorGUI.BeginDisabledGroup(_N_F_LLI.floatValue == 0);
                    materialEditor.ShaderProperty(_LLI_Min, new GUIContent(_LLI_Min.displayName, TOTIPS[149]));
                    materialEditor.ShaderProperty(_LLI_Max, new GUIContent(_LLI_Max.displayName, TOTIPS[150]));
                    EditorGUI.EndDisabledGroup();
                ...
                if (_N_F_RL.floatValue == 1)
                {
                    ...
                    if (ShowRimLight)
                    {
                        ...
                        materialEditor.ShaderProperty(_RimLigPosi, new GUIContent(_RimLigPosi.displayName, TOTIPS[155]));
                ...
                if (_N_F_PA.floatValue == 1)
                {
                    ...
                    if (ShowPerspecAdju)
                    {
                        ...
                        materialEditor.ShaderProperty(_PresAdju, new GUIContent(_PresAdju.displayName, TOTIPS[142]));
                        materialEditor.ShaderProperty(_ClipAdju, new GUIContent(_ClipAdju.displayName, TOTIPS[143]));

                        GUILayout.Space(10);

                        materialEditor.ShaderProperty(_PASize, new GUIContent(_PASize.displayName, TOTIPS[144]));
                        materialEditor.ShaderProperty(_PASmooTrans, new GUIContent(_PASmooTrans.displayName, TOTIPS[145]));
                        materialEditor.ShaderProperty(_PADist, new GUIContent(_PADist.displayName, TOTIPS[146]));
                ...
                if (ShowDisableEnable)
                {
                    ...
                    materialEditor.ShaderProperty(_N_F_PA, new GUIContent(_N_F_PA.displayName, TOTIPSEDF[18]));
                    EditorGUILayout.EndVertical();
                ...
                if (ShowSettings)
                {
                    ...
                    if (GUILayout.Button(new GUIContent(enab_vrclvs_string, TOTIPS[147]), "Button"))
                    {
                        ENAB_VRCLVS();
                    }
                ...
                materialEditor.ShaderProperty(_ObjePosiZCS, new GUIContent(_ObjePosiZCS.displayName, TOTIPS[154]));
        ...
        void ENAB_VRCLVS()
        {
            ...
            {
                Debug.Log("'VRC Light Volumes' is present in your project.");

                if (enab_vrclvs == false)
                {

                    if (Directory.Exists("Assets/VRC Light Volumes"))
                    {

                        ChanLi("static bool enab_vrclvs = false;", "static bool enab_vrclvs = true;", "Assets/RealToon/Editor/RealToonShaderGUI.cs");
                        ChanLi("static string enab_vrclvs_string = " + (char)34 + "Enable 'VRC Light Volumes' Support" + (char)34 + ";", "static string enab_vrclvs_string = " + (char)34 + "Disable 'VRC Light Volumes' Support" + (char)34 + ";", "Assets/RealToon/Editor/RealToonShaderGUI.cs");

                        ChanLi("//DDVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DDVRC_LV_F", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Default.shader");
                        ChanLi("//DDVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DDVRC_LV_A", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Default.shader");

                        ChanLi("//DFTVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DFTVRC_LV_F", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Fade_Transparency.shader");
                        ChanLi("//DFTVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DFTVRC_LV_A", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Fade_Transparency.shader");

                        ChanLi("//DRVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DRVRC_LV_F", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Refraction.shader");
                        ChanLi("//DRVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DRVRC_LV_A", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Refraction.shader");

                        ChanLi("//DDTVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DDTVRC_LV_F", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Default.shader");
                        ChanLi("//DDTVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DDTVRC_LV_A", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Default.shader");

                        ChanLi("//DFTTVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DFTTVRC_LV_F", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Fade_Transparency.shader");
                        ChanLi("//DFTTVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DFTTVRC_LV_A", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Fade_Transparency.shader");

                        ChanLi("//DRTVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DRTVRC_LV_F", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Refraction.shader");
                        ChanLi("//DRTVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DRTVRC_LV_A", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Refraction.shader");

                    }
                    else if (Directory.Exists("Packages/red.sim.lightvolumes"))
                    {
                        ChanLi("static bool enab_vrclvs = false;", "static bool enab_vrclvs = true;", "Assets/RealToon/Editor/RealToonShaderGUI.cs");
                        ChanLi("static string enab_vrclvs_string = " + (char)34 + "Enable 'VRC Light Volumes' Support" + (char)34 + ";", "static string enab_vrclvs_string = " + (char)34 + "Disable 'VRC Light Volumes' Support" + (char)34 + ";", "Assets/RealToon/Editor/RealToonShaderGUI.cs");

                        ChanLi("//DDVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DDVRC_LV_F2", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Default.shader");
                        ChanLi("//DDVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DDVRC_LV_A2", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Default.shader");

                        ChanLi("//DFTVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DFTVRC_LV_F2", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Fade_Transparency.shader");
                        ChanLi("//DFTVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DFTVRC_LV_A2", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Fade_Transparency.shader");

                        ChanLi("//DRVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DRVRC_LV_F2", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Refraction.shader");
                        ChanLi("//DRVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DRVRC_LV_A2", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Refraction.shader");

                        ChanLi("//DDTVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DDTVRC_LV_F2", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Default.shader");
                        ChanLi("//DDTVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DDTVRC_LV_A2", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Default.shader");

                        ChanLi("//DFTTVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DFTTVRC_LV_F2", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Fade_Transparency.shader");
                        ChanLi("//DFTTVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DFTTVRC_LV_A2", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Fade_Transparency.shader");

                        ChanLi("//DRTVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DRTVRC_LV_F2", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Refraction.shader");
                        ChanLi("//DRTVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DRTVRC_LV_A2", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Refraction.shader");
                    }

                    AssetDatabase.ImportAsset("Assets/RealToon/RealToon Shaders/Version 5/Default/D_Default.shader");
                    AssetDatabase.ImportAsset("Assets/RealToon/RealToon Shaders/Version 5/Default/D_Fade_Transparency.shader");
                    AssetDatabase.ImportAsset("Assets/RealToon/RealToon Shaders/Version 5/Default/D_Refraction.shader");
                    AssetDatabase.ImportAsset("Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Default.shader");
                    AssetDatabase.ImportAsset("Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Fade_Transparency.shader");
                    AssetDatabase.ImportAsset("Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Refraction.shader");

                    AssetDatabase.ImportAsset("Assets/RealToon/Editor/RealToonShaderGUI.cs");
                    Debug.LogWarning("'VRC Light Volume' is now supported.");
                }
                else if (enab_vrclvs == true)
                {
                    if (Directory.Exists("Assets/VRC Light Volumes"))
                    {
                        ChanLi("static bool enab_vrclvs = true;", "static bool enab_vrclvs = false;", "Assets/RealToon/Editor/RealToonShaderGUI.cs");
                        ChanLi("static string enab_vrclvs_string = " + (char)34 + "Disable 'VRC Light Volumes' Support" + (char)34 + ";", "static string enab_vrclvs_string = " + (char)34 + "Enable 'VRC Light Volumes' Support" + (char)34 + ";", "Assets/RealToon/Editor/RealToonShaderGUI.cs");

                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DDVRC_LV_F", "//DDVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Default.shader");
                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DDVRC_LV_A", "//DDVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Default.shader");

                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DFTVRC_LV_F", "//DFTVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Fade_Transparency.shader");
                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DFTVRC_LV_A", "//DFTVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Fade_Transparency.shader");

                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DRVRC_LV_F", "//DRVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Refraction.shader");
                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DRVRC_LV_A", "//DRVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Refraction.shader");

                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DDTVRC_LV_F", "//DDTVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Default.shader");
                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DDTVRC_LV_A", "//DDTVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Default.shader");

                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DFTTVRC_LV_F", "//DFTTVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Fade_Transparency.shader");
                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DFTTVRC_LV_A", "//DFTTVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Fade_Transparency.shader");

                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DRTVRC_LV_F", "//DRTVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Refraction.shader");
                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//DRTVRC_LV_A", "//DRTVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Refraction.shader");
                    }
                    else if (Directory.Exists("Packages/red.sim.lightvolumes"))
                    {
                        ChanLi("static bool enab_vrclvs = true;", "static bool enab_vrclvs = false;", "Assets/RealToon/Editor/RealToonShaderGUI.cs");
                        ...
                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DDVRC_LV_F2", "//DDVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Default.shader");
                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DDVRC_LV_A2", "//DDVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Default.shader");

                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DFTVRC_LV_F2", "//DFTVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Fade_Transparency.shader");
                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DFTVRC_LV_A2", "//DFTVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Fade_Transparency.shader");

                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DRVRC_LV_F2", "//DRVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Refraction.shader");
                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DRVRC_LV_A2", "//DRVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Default/D_Refraction.shader");

                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DDTVRC_LV_F2", "//DDTVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Default.shader");
                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DDTVRC_LV_A2", "//DDTVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Default.shader");

                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DFTTVRC_LV_F2", "//DFTTVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Fade_Transparency.shader");
                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DFTTVRC_LV_A2", "//DFTTVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Fade_Transparency.shader");

                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DRTVRC_LV_F2", "//DRTVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Refraction.shader");
                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//DRTVRC_LV_A2", "//DRTVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Tessellation/T_Refraction.shader");
                    }
                    ...
                    AssetDatabase.ImportAsset("Assets/RealToon/Editor/RealToonShaderGUI.cs");
                    Debug.LogWarning("'VRC Light Volume' support is now disabled.");
                }
            }
            else
            {
                Debug.LogWarning("'VRC Light Volumes' is not present in your project, you need to download and import 'VRC Light Volumes' package.\nIf you are using the VRC Light Volumes Unity Package version, It should be in the 'Assets/' project folder not inside of other folder.");
                Debug.LogWarning("Be sure the folder name is 'VRC Light Volumes' not 'VRCLightVolumes'");
