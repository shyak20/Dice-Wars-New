...
static string enab_vrclvs_string = "Enable 'VRC Light Volumes' Support";
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            switch (targetMat.shader.name)
            {
                case "RealToon/Version 5/Lite/Default":
                    shader_name = "lite_d";
                    shader_type = "Default - With Lightmap";
                    break;
            ...
            EditorGUILayout.LabelField("RealToon Lite 5.0.14", EditorStyles.boldLabel);
            ...
            if (ShowUI == true)
            {
                ...
                if (shader_name == "lite_d")
                {
                    if (_L_F_O.floatValue == 1)
                    {
                        ...
                        if (ShowOutline)
                        {
                            ...
                            materialEditor.ShaderProperty(_OutResi, new GUIContent(_OutResi.displayName, TOTIPS[109]));
                ...
                if (_L_F_SL.floatValue == 1)
                {
                    ...
                    if (ShowSelfLit)
                    {
                        ...
                        materialEditor.ShaderProperty(_N_F_SLMM, new GUIContent(_N_F_SLMM.displayName, TOTIPS[107]));

                        GUILayout.Space(1);

                        if (_N_F_SLMM.floatValue == 1)
                        {
                            materialEditor.ShaderProperty(_MaskSelfLit, new GUIContent("Self Lit Map", TOTIPS[108]));
                        }
                        else
                        {
                ...
                if (ShowShadow)
                {
                    ...
                    if (_L_F_ST.floatValue == 1)
                    {
                        ...
                        if (_L_F_ST.floatValue == 1)
                        {
                            ...
                            EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
                            materialEditor.ShaderProperty(_N_F_STSDFM, new GUIContent(_N_F_STSDFM.displayName, TOTIPS[97]));
                ...
                if (ShowLighting)
                {
                    ...
                    GUILayout.Space(10);
                    materialEditor.ShaderProperty(_N_F_LLI, new GUIContent(_N_F_LLI.displayName, TOTIPS[104]));
                    EditorGUI.BeginDisabledGroup(_N_F_LLI.floatValue == 0);
                    materialEditor.ShaderProperty(_LLI_Min, new GUIContent(_LLI_Min.displayName, TOTIPS[105]));
                    materialEditor.ShaderProperty(_LLI_Max, new GUIContent(_LLI_Max.displayName, TOTIPS[106]));
                    EditorGUI.EndDisabledGroup();
                ...
                if (_L_F_RL.floatValue == 1)
                {
                    ...
                    if (ShowRimLight)
                    {
                        ...
                        materialEditor.ShaderProperty(_RimLigPosi, new GUIContent(_RimLigPosi.displayName, TOTIPS[111]));
                ...
                if (_N_F_PA.floatValue == 1)
                {
                    ...
                    if (ShowPerspecAdju)
                    {
                        ...
                        materialEditor.ShaderProperty(_PresAdju, new GUIContent(_PresAdju.displayName, TOTIPS[98]));
                        materialEditor.ShaderProperty(_ClipAdju, new GUIContent(_ClipAdju.displayName, TOTIPS[99]));

                        GUILayout.Space(10);

                        materialEditor.ShaderProperty(_PASize, new GUIContent(_PASize.displayName, TOTIPS[100]));
                        materialEditor.ShaderProperty(_PASmooTrans, new GUIContent(_PASmooTrans.displayName, TOTIPS[101]));
                        materialEditor.ShaderProperty(_PADist, new GUIContent(_PADist.displayName, TOTIPS[102]));
                ...
                if (ShowDisableEnable)
                {
                    ...
                    materialEditor.ShaderProperty(_N_F_PA, new GUIContent(_N_F_PA.displayName, TOTIPSEDF[14]));
                    EditorGUILayout.EndVertical();
                ...
                if (ShowSettings)
                {
                    ...
                    if (GUILayout.Button(new GUIContent(enab_vrclvs_string, TOTIPS[103]), "Button"))
                    {
                        ENAB_VRCLVS();
                    }
                ...
                materialEditor.ShaderProperty(_ObjePosiZCS, new GUIContent(_ObjePosiZCS.displayName, TOTIPS[110]));
        ...
        void ENAB_VRCLVS()
        {
            ...
            {
                Debug.Log("'VRC Light Volume' is present in your project.");
                ...
                if (enab_vrclvs == false)
                {
                    ...
                    {
                        ChanLi("static bool enab_vrclvs = false;", "static bool enab_vrclvs = true;", "Assets/RealToon/Editor/RealToonShaderGUI_Lite.cs");
                        ChanLi("static string enab_vrclvs_string = " + (char)34 + "Enable 'VRC Light Volumes' Support" + (char)34 + ";", "static string enab_vrclvs_string = " + (char)34 + "Disable 'VRC Light Volumes' Support" + (char)34 + ";", "Assets/RealToon/Editor/RealToonShaderGUI_Lite.cs");

                        ChanLi("//LDVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//LDVRC_LV_F", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Default.shader");
                        ChanLi("//LDVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//LDVRC_LV_A", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Default.shader");

                        ChanLi("//LFTVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//LFTVRC_LV_F", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Fade_Transparency.shader");
                        ChanLi("//LFTVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//LFTVRC_LV_A", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Fade_Transparency.shader");
                    }
                    else if (Directory.Exists("Packages/red.sim.lightvolumes"))
                    {
                        ...
                        ChanLi("//LDVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//LDVRC_LV_F2", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Default.shader");
                        ChanLi("//LDVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//LDVRC_LV_A2", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Default.shader");

                        ChanLi("//LFTVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//LFTVRC_LV_F2", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Fade_Transparency.shader");
                        ChanLi("//LFTVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//LFTVRC_LV_A2", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Fade_Transparency.shader");
                    }


                    AssetDatabase.ImportAsset("Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Default.shader");
                    AssetDatabase.ImportAsset("Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Fade_Transparency.shader");

                    AssetDatabase.ImportAsset("Assets/RealToon/Editor/RealToonShaderGUI_Lite.cs");
                ...
                else if (enab_vrclvs == true)
                {
                    if (Directory.Exists("Assets/VRC Light Volumes"))
                    {
                        ChanLi("static bool enab_vrclvs = true;", "static bool enab_vrclvs = false;", "Assets/RealToon/Editor/RealToonShaderGUI_Lite.cs");
                        ChanLi("static string enab_vrclvs_string = " + (char)34 + "Disable 'VRC Light Volumes' Support" + (char)34 + ";", "static string enab_vrclvs_string = " + (char)34 + "Enable 'VRC Light Volumes' Support" + (char)34 + ";", "Assets/RealToon/Editor/RealToonShaderGUI_Lite.cs");

                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//LDVRC_LV_F", "//LDVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Default.shader");
                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//LDVRC_LV_A", "//LDVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Default.shader");

                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//LFTVRC_LV_F", "//LFTVRC_LV_F#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Fade_Transparency.shader");
                        ChanLi("#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"//LFTVRC_LV_A", "//LFTVRC_LV_A#include \"../../../../VRC Light Volumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Fade_Transparency.shader");
                    }
                    else if (Directory.Exists("Packages/red.sim.lightvolumes"))
                    {
                        ChanLi("static bool enab_vrclvs = true;", "static bool enab_vrclvs = false;", "Assets/RealToon/Editor/RealToonShaderGUI_Lite.cs");
                        ...
                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//LDVRC_LV_F2", "//LDVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Default.shader");
                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//LDVRC_LV_A2", "//LDVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Default.shader");

                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//LFTVRC_LV_F2", "//LFTVRC_LV_F2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Fade_Transparency.shader");
                        ChanLi("#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"//LFTVRC_LV_A2", "//LFTVRC_LV_A2#include \"Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc\"", "Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Fade_Transparency.shader");
                    }
                    AssetDatabase.ImportAsset("Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Default.shader");
                    AssetDatabase.ImportAsset("Assets/RealToon/RealToon Shaders/Version 5/Lite/L_Fade_Transparency.shader");
