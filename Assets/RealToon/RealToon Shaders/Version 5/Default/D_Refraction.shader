...
//DRVRC_LV_F#include "../../../../VRC Light Volumes/Shaders/LightVolumes.cginc"
//DRVRC_LV_F2#include "Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc"
...
;
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR 
			{
                ...
                float attenuation = 1;
					...
					half3 RTD_SON_ON_OTHERS = lerp(normalDirection,-normalize(_XYZPosition.xyz - i.posWorld.rgb),RTD_SON_VCBSON_OO);
				...
				half3 RTD_FR_OFF_OTHERS = Ref( viewReflectDirection , _ReflectionRoughtness );
					...
					half3 RTD_SL_OFF_OTHERS = (AL_GI( lerp(float3(node_3622,node_3622,node_3622),float3(node_7998,node_7998,node_7998),RTD_GI_FS_OO),i.posWorld.xyz)*_EnvironmentalLightingIntensity);
					...
					half3 RTD_R_SEL = (half3)0.0;
						...
						RTD_R_SEL = lerp(RTD_R,lerp(RTD_R,RTD_TEX_COL_REF*_TEXMCOLINT,_MaskSelfLit_var.rgb),_SelfLitIntensity);
					#else
						half3 RTD_SL_HC_OO = lerp( 1.0, RTD_TEX_COL_REF, _SelfLitHighContrast );
						RTD_SL_MAS = lerp(RTD_SL_OFF_OTHERS,((_SelfLitColor.rgb*RTD_TEX_COL_REF*RTD_SL_HC_OO)*_SelfLitPower),_MaskSelfLit_var.r);
						RTD_R_SEL = lerp(RTD_R,lerp(RTD_R,RTD_TEX_COL_REF*_TEXMCOLINT,_MaskSelfLit_var.r),_SelfLitIntensity);
					#endif
...
//DRVRC_LV_A#include "../../../../VRC Light Volumes/Shaders/LightVolumes.cginc"
//DRVRC_LV_A2#include "Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc"
