...
//DFTVRC_LV_F#include "../../../../VRC Light Volumes/Shaders/LightVolumes.cginc"
//DFTVRC_LV_F2#include "Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc"
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR 
			{
				...
				half3 RTD_R_OFF_OTHERS = ( lerp( RTD_TEX_COL , _MainTex_var.rgb , _MCIALO)  * lerp((RTD_LAS*RTD_LVLC*RTD_ST_IS),RTD_ST,RTD_SS)); //5.0.4
					...
					float node_3622 = 0.0;
					float node_491 = 1.0;
					half3 RTD_SL_OFF_OTHERS = (AL_GI( lerp(float3(node_3622,node_3622,node_3622),float3(node_491,node_491,node_491),RTD_GI_FS_OO),i.posWorld.xyz)*_EnvironmentalLightingIntensity);
					...
					half3 RTD_R_SEL = (half3)0.0;
						...
						RTD_R_SEL = lerp(RTD_R,lerp(RTD_R,RTD_TEX_COL,_MaskSelfLit_var.rgb),_SelfLitIntensity);
					#else
						...
						RTD_R_SEL = lerp(RTD_R,lerp(RTD_R,RTD_TEX_COL,_MaskSelfLit_var.r),_SelfLitIntensity);
					#endif
...
//DFTVRC_LV_A#include "../../../../VRC Light Volumes/Shaders/LightVolumes.cginc"
//DFTVRC_LV_A2#include "Packages/red.sim.lightvolumes/Shaders/LightVolumes.cginc"
